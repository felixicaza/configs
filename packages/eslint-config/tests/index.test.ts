...
describe('index public API', () => {
  it('builds default config with global ignores and presets', () => {
    ...
    expect(findNamedConfig(result, 'felixicaza/astro/doctor')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/astro/style')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/astro/internal/style')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/css')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/css/order')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/css/stylistic')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/json/global')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/json')).toBeDefined()
    expect(findNamedConfig(result, 'felixicaza/pnpm-workspace')).toBeUndefined()
